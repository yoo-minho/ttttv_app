...
public class AppRTCBluetoothManager {
  ...
  private final com.uminoh.bulnati.WebRtcUtil.Audio.AppRTCAudioManager apprtcAudioManager;
  ...
  /** Construction. */
  static AppRTCBluetoothManager create(Context context, com.uminoh.bulnati.WebRtcUtil.Audio.AppRTCAudioManager audioManager) {
    Log.d(TAG, "create" + AppRTCUtils.getThreadInfo());
    return new AppRTCBluetoothManager(context, audioManager);
  }

  protected AppRTCBluetoothManager(Context context, com.uminoh.bulnati.WebRtcUtil.Audio.AppRTCAudioManager audioManager) {
    Log.d(TAG, "ctor");
